...
CREATE TABLE IF NOT EXISTS pac_summary (
    cmte_id text, -- CMTE_ID,Committee identification,1,N,VARCHAR2 (9),,C00100005
    cmte_nm text, -- CMTE_NM,Committee name,2,Y,VARCHAR2 (200),,National Finance Political Action Committee
    cmte_tp text, -- CMTE_TP,Committee type,3,Y,VARCHAR2 (1),,Q
    cmte_dsgn text, -- CMTE_DSGN,Committee designation,4,Y,VARCHAR2 (1),,U
    cmte_filing_freq text, -- CMTE_FILING_FREQ,Committee filing frequency,5,Y,VARCHAR2 (1),,M
    ...
    cvg_end_dt text, -- CVG_END_DT,Coverage end date,27,Y,DATE(MM/DD/YYYY),Through date,04/30/2018
    file_year INTEGER,
